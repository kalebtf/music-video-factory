...
- [x] All via FFmpeg drawtext alpha+y expressions
...
## Bug Fixes Log
- [x] base_y not defined (P0) — variable missing before drawtext loop
...
- [x] Animation status case mismatch — COMPLETED vs completed
